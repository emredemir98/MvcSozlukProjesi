...
namespace MvcProjeKampi.Controllers
{
    public class WriterPanelController : Controller
    {
        ...
        WriterValidator writervalidotor = new WriterValidator();
        ...
        {
            ValidationResult results = writervalidotor.Validate(p);
            if (results.IsValid)
            {
                wm.WriterUpdate(p);
        ...
        public ActionResult WriterProfilePage(int id)
        {
           
            var writerValue = wm.GetByID(id);
            return View(writerValue);
        }
        public PartialViewResult WriterProfileHeadingInfo(int id)
        {
            
            var writerValue = com.GetListByWriter(id);
